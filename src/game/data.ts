...
export type Character = {
  id:string; name:string; role:Role; rarity:number; maxHp:number; attack:number; defense:number; speed:number; ability:string; tags:string[];
};

export type DevilFruit = {
  id:string; name:string; type:"Paramecia"|"Zoan"|"Logia"; effect:string; attack:number; maxHp:number;
};
...
{id:"mera",name:"Mera Mera no Mi",type:"Logia",effect:"Burn: i prossimi 3 attacchi infliggono +15 danni.",attack:22,maxHp:0},
...
{id:"suna",name:"Suna Suna no Mi",type:"Logia",effect:"Sand Trap: riduce di 12% l'attacco del nemico.",attack:15,maxHp:20},
];
